...
model_paths = {
    ...
    'pretrained_e4e_encoder': '/scratch/users/abaykal20/sam/SAM/pretrained_models/e4e_ffhq_encode.pt',
    'ir_se50': '/scratch/users/abaykal20/sam/SAM/pretrained_models/model_ir_se50.pth',
    'stylegan_ffhq': '/scratch/users/abaykal20/sam/SAM/pretrained_models/stylegan2-ffhq-config-f.pt'
}
